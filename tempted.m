                ...
                if length(ind) ~= size(unq_coord,1)
                    for j=1:length(unq_coord)
                        ...
                        if length(ind2) > 1
                            ...
                            switch latlon
                                case 1
                                    barh([unq_coord(j);unq_coord(j)+.01],[mean(surface(ind2,8:9)) mean(surface(ind2,15:16));NaN NaN NaN NaN],0.4,'stacked')
                                    axis([0 1 41.13 41.34])
                                case 2
                                    bar([unq_coord(j);unq_coord(j)+.01],[mean(surface(ind2,8:9)) mean(surface(ind2,15:16));NaN NaN NaN NaN],0.4,'stacked')
                                    axis([-70.70 -70.40 0 1])
                            end
                            hold on
                            ...
                            switch latlon
                                case 1
                                    ...
                                    axis([0 1 41.13 41.34])
                                case 2
                                    bar(unq_coord(j),[mean(surface(ind2,8:9)) mean(surface(ind2,15:16))],0.4,'stacked')
                                    axis([-70.70 -70.40 0 1])
                            end
