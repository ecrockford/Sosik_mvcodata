...
fprintf(fid,'!\n');
fprintf(fid,'! Samples were collected under vacuum (~5 in Hg) and filtered through 25mm Whatman GF/F filters and stored in liquid nitrogen prior to analysis\n');
fprintf(fid,'!\n');
